...
import 'package:thingsboard_app/modules/bridge/wifiWs_routes.dart';
import 'package:thingsboard_app/modules/bridge/wifi_routes.dart';
...
class ThingsboardAppRouter {
  ...
  ThingsboardAppRouter() {
    ...
    WiFiRoutes(_tbContext).registerRoutes();
    WiFiWsRoutes(_tbContext).registerRoutes();
  }
