...
class _LoginPageState extends TbPageState<LoginPage>
  ...
  Future<void> _readFromStorage() async {
    ...
    if (_debug) {
      print('_readFromStorage> USERNAME: $_username::');
      print('_readFromStorage> PASSWORD: $_password::');
    }
  }
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        ...
                                        style: TbTextStyles.bodyLarge.copyWith(color: Colors.white),
                                      ),
                                    ...
                                    OutlinedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        try {
                                          ...
                                          log.error(
                                            'Error al acceder con código QR',
                            ...
                            children: [
                              TextButton(
                                ...
                                child: Text(
                                  ...
                                  style: TbTextStyles.bodyMedium.copyWith(color: Colors.lightBlue, fontStyle: FontStyle.italic),
                                ),
                              ),
                            ],
                          ),
  ...
  void _login() async {
    ...
    if (_loginFormKey.currentState?.saveAndValidate() ?? false) {
      ...
      try {
        ...
        if (_debug) {
          print('_login> USERNAME: $_username::$username');
          print('_login> PASSWD: $_password::$password');
        }
        if (username != _username) {
          _usernameController.text = username;
          await _storage.write(key: 'KEY_USERNAME', value: username);
          if (_debug) print('_login> GRABANDO USERNAME: $username');
        }
        if (password != _password) {
          _passwordController.text = password;
          await _storage.write(key: 'KEY_PASSWORD', value: password);
          if (_debug) print('_login> GRABANDO PASSWORD: $password');
        }
        //}
      } catch (e) {
        _isLoginNotifier.value = false;
