...
mixin AuditLogsBase on EntitiesBase<AuditLog, TimePageLink> {
  @override
  String get title => 'Registros de auditoría';
  //String get title => 'Audit Logs';

  @override
  String get noItemsFoundText => 'No se han encontrado registros de auditoría';
...
class _AuditLogCardState extends TbContextState<AuditLogCard> {
  final entityDateFormat = DateFormat('dd/MM/yyyy');
