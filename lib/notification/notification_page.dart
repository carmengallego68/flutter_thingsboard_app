      ...
      appBar: TbAppBar(
        ...
        actions: [
          TextButton(
            ...
            child: Text(S.of(context).markAllRead, style: TextStyle(color: Colors.white, fontSize: 10)),
                ...
                children: [
                  Padding(
                    ...
                    child: FilterSegmentedButton(
                      ...
                      segments: const [
                        FilterSegments(
                          //label: Text(S.of(context).unread, style: TextStyle(color: Colors.white)),
                          label: 'No leído',
                          //label: 'Unread',
                  ...
                  OutlinedButton(
                    style: OutlinedButton.styleFrom(
                      ...
                      //backgroundColor: Color(0xFF0D2743),
                    ),
                    onPressed: () async {
                      await notificationRepository.markAllAsRead();
                      if (mounted) {
                    ...
                    child: Center(
                      child: Text(S.of(context).markAllRead, style: const TextStyle(color: Colors.white)),
                    ),
                  ),
