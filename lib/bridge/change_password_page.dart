...
class ChangeWiFiPasswordPage extends TbContextWidget {
  ChangeWiFiPasswordPage(TbContext tbContext, {super.key}) : super(tbContext);

  @override
  State<StatefulWidget> createState() => _ChangeWiFiPasswordPageState();
}

class _ChangeWiFiPasswordPageState extends TbContextState<ChangeWiFiPasswordPage> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Center(
                          child: Text(S.of(context).changePassword, style: TextStyle(color: Colors.white)),
                        ),
                      ),
                    ],
                  ),
